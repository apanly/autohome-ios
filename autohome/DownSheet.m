...
-(id)initWithlist:(NSArray *)list height:(CGFloat)height{
    self = [super init];
    if(self){
        self.frame = CGRectMake(0, [AppGlobal getStatusBarHeight], ScreenWidth, ScreenHeight - [AppGlobal getToolBarHeight] - [AppGlobal getStatusBarHeight]);
...
- (void)animeData{
    ...
    [UIView animateWithDuration:.25 animations:^{
        ...
        [UIView animateWithDuration:.25 animations:^{
            [view setFrame:CGRectMake(view.frame.origin.x, ScreenHeight-view.frame.size.height-60, view.frame.size.width, view.frame.size.height)];
        }];
...
- (void)show{
    //[view setFrame:CGRectMake(0, [AppGlobal getStatusBarHeight], ScreenWidth, ScreenHeight - [AppGlobal getToolBarHeight] - [AppGlobal getStatusBarHeight])];
    self.alpha = 1;
    self.hidden = NO;
    self.isShow = YES;
}
